...
def make_report_figures(texts, dataset, detections_per_day, stats, outdir="figs_tmp"):
    ...
    plt.figure(figsize=(12,6))
    detections_per_day.plot(kind='line', marker='o', label=texts["labels"]["all_detections"])
    stats['annoted_per_day'].plot(kind='line', marker='x', label=texts["labels"]["annoted_alerts"])
    plt.title(texts["titles"]["daily_detections"])
    plt.xlabel(texts["axes"]["daily_detections"]["x"])
    plt.ylabel(texts["axes"]["daily_detections"]["y"])
    plt.xticks(rotation=45)
    plt.legend()
    plt.tight_layout()
    ...
    plt.figure(figsize=(12,6))
    stats['false_positives_per_day'].plot(kind='line', marker='s', label=texts["labels"]["false_positives"])
    plt.title(texts["titles"]["false_positives"])
    plt.xlabel(texts["axes"]["false_positives"]["x"])
    plt.ylabel(texts["axes"]["false_positives"]["y"])
    plt.xticks(rotation=45)
    plt.legend()
    plt.tight_layout()
    plt.savefig(fig_path, dpi=150)
    ...
    plt.figure(figsize=(12,6))
    stats['true_positives_per_day'].plot(kind='line', marker='o', color='green', label=texts["labels"]["true_positives"])
    plt.title(texts["titles"]["confirmed_fires"])
    plt.xlabel(texts["axes"]["confirmed_fires"]["x"])
    plt.ylabel(texts["axes"]["confirmed_fires"]["y"])
    plt.xticks(rotation=45)
    plt.legend()
    plt.tight_layout()
    plt.savefig(fig_path, dpi=150)
    ...
    plt.figure(figsize=(12,6))
    stats['detections_per_hour'].plot(kind='bar', label=texts["labels"]["detections_by_hour"])
    plt.title(texts["titles"]["detections_by_hour"])
    plt.xlabel(texts["axes"]["detections_by_hour"]["x"])
    plt.ylabel(texts["axes"]["detections_by_hour"]["y"])
    plt.legend()
    plt.tight_layout()
    plt.savefig(fig_path, dpi=150)
    plt.close()
    ...
    plt.xlabel(texts["axes"]["alerts_distribution"]["x"])
    plt.ylabel(texts["axes"]["alerts_distribution"]["y"])
    plt.legend([texts["labels"]["true_positives"], texts["labels"]["false_positives"], texts["labels"]["unlabeled"]])
    plt.tight_layout()
    plt.savefig(fig_path, dpi=150)
    plt.close()
    paths.append(fig_path)
    ...
    plt.xlabel(texts["axes"]["site_hourly_comparison"]["x"])
    plt.ylabel(texts["axes"]["site_hourly_comparison"]["y"])
    plt.legend(title=texts["labels"]["site"])
    plt.tight_layout()
    plt.savefig(fig_path, dpi=150)
    plt.close()
    paths.append(fig_path)
